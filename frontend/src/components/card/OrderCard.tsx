...
import { OrderPage, OrderProps, Item, ItemProps, OrderStatsProps } from "types/order";
...
export function GetLastOrderCard() {
    ...
    const [orderList, setOrderList] = useState<OrderPage>({ content: [], number: 0 });
    useEffect(() => {
    ...
    return (
        <>
            ...
            <div className="gerencg-item-card">
                ...
                <div className="gerencg-box ">
                    <h3>Valor Total: {item?.expense.toFixed(2)}</h3>
                </div>
                <div className="gerencg-box">
